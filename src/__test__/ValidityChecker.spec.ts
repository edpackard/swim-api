...
describe('isSwimValid', () => {
  ...
  it('returns false for an invalid swim object', () => {
    ...
    const badObject2 = { id: 1, lengths: 200, pool: 'New Pool', date: null}
    const badObject3 = { id: 1, lengths: 200, pool: true, date: date }
    const badObject4 = { id: 1, lengths: "200", pool: 'New Pool', date: date }
    const badObject5 = { id: null, lengths: 200, pool: 'New Pool', date: date }
    ...
    expect(validityChecker.isSwimValid(badObject5)).toBe(false)
